...
import '../studentPages/search_page.dart';
                                  ...
                                  children: [
                                    IconButton(
                                      ...
                                      icon: const Icon(
                                        Icons.edit,
                                        color:
                                            Color.fromARGB(255, 87, 94, 107),
                                      ),
                                    ),
                                    IconButton(
                                      onPressed: () {
                                        deleteAlert(context, student[index]);
                                      },
                                      icon: const Icon(
                                        Icons.delete,
                                        color:
                                            Color.fromARGB(255, 225, 99, 90),
                                      ),
                                    ),
                                  ],
                                ),
  ...
  showDialog(
    ...
    builder: (ctx) {
      return AlertDialog(
        ...
        backgroundColor: const Color.fromARGB(255, 197, 201, 204),
        content: Text(
